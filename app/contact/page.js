...
const Contact = () => {
  ...
  return (
    <>
    <Toaster/>
    <form onSubmit={(e)=>{handleSubmit(e);toast.success('Successfully submitted!');setForm({name: '',email: '',message: ''});}} className='mt-12 flex flex-col justify-center items-center gap-4 p-3'>
